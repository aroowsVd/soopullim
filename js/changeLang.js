document.addEventListener('DOMContentLoaded', () => {
    const translations = {
        ko: {
            about_h4: "안녕하세요 꾸준히 성장하는 신입 퍼블리셔 임성욱입니다.",
            about_h5: "직관적인 사용자 경험을 최우선으로 고려하여 빠르게 변화하는 웹 트렌드에 대응하여 업계에서 경쟁력 있는 웹 퍼블리셔가 되도록 노력하겠습니다.",
            skill_h4: "기술을 통해 감성을 전달하는 퍼블리셔",
